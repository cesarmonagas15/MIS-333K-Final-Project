...
namespace fa23team33_finalproject.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MovieID,Title,Description,Tagline,ReleaseYear,MPAArating,Actors,RunTime")] Movie movie)
        {
        ...
        [Authorize(Roles = "Manager")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieID,Title,Description,Tagline,ReleaseYear,MPAArating,Actors,RunTime")] Movie movie)
        {
            if (id != movie.MovieID)
            {
                return NotFound();
